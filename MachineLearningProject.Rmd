...
```
The best tuning paramter is 0.01526418 and the highest accuracy is 0.7547594.
...
The accuracy using the entire training dataset is 0.8364  which is significantly greater than the cross-validated accuracy 0.7547594. This could be because the model is overfitted since we use the entire training data set.     
...
kable(db_randf_model$results, caption = "An example table caption.")
```
...
# Summary-train
    ...
    -----------|-------------|-------------|-------------|-------------|-------------
    Accuracy   |0.7844[4]    |0.7657[2]    |0.7657[2]    |0.7547[1]    |0.7843[5] 
    AUC        |0.8320[2]    |0.8479[4]    |0.8469[3]    |0.8677[5]    |0.8157[1]  
