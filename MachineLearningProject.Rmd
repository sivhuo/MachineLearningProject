...
db_train %>% 
  ...
  auc()
```
Then, we plotted the ROC curve and computed the AUC for this model, which is 0.832.
...
```{r}
summary_train <- matrix(c(0.784,0.792,0.792,0.7492,0.7881,0.832,0.848,0.847, 0.8601,0.8266),ncol=5,byrow=TRUE)
colnames(summary_train) <- c("4-var","all-var","Lasso", "Classification tree", "Random forest")
rownames(summary_train) <- c("Accuracy","AUC")
